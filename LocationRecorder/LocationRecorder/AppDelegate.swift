...
class AppDelegate: UIResponder, UIApplicationDelegate, CLLocationManagerDelegate, WCSessionDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        let iPhoneAppContext = ["latitude": currentLocation?.coordinate.latitude, "longitude": currentLocation?.coordinate.longitude]
        do {
            try session?.updateApplicationContext(iPhoneAppContext as [String : Any])
        } catch {
